...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsWordclockWordClock = __webpack_require__(51);

	var _componentsWordclockWordClock2 = _interopRequireDefault(_componentsWordclockWordClock);

	var _componentsBinaryclockClock = __webpack_require__(56);

	var _componentsBinaryclockClock2 = _interopRequireDefault(_componentsBinaryclockClock);
	...
	var routes = _react2['default'].createElement(
	  ...
	  _react2['default'].createElement(
	    _reactRouter.Route,
	    { path: '/', component: App },
	    _react2['default'].createElement(_reactRouter.IndexRoute, { component: _componentsWordclockWordClock2['default'] }),
	    _react2['default'].createElement(_reactRouter.Route, { path: '/word', component: _componentsWordclockWordClock2['default'] }),
	    _react2['default'].createElement(_reactRouter.Route, { path: '/binary', component: _componentsBinaryclockClock2['default'] })
	  )
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RoutingContext2 = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RoutingContext = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getRouteParams = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Word = __webpack_require__(52);
	...
	var _Minute = __webpack_require__(55);

	var _Minute2 = _interopRequireDefault(_Minute);

	var data = [{ text: 'TEN', ranges: [[10, 14], [50, 54]] }, { text: 'QUARTER', ranges: [[15, 19], [45, 49]] }, { text: 'TWENTY', ranges: [[20, 29], [35, 44]] }, { text: 'FIVE', ranges: [[5, 9], [25, 29], [35, 39], [55, 59]] }, { text: 'HALF', ranges: [[30, 34]] }, { text: 'PAST', ranges: [[5, 34]] }, { text: 'TO', ranges: [[35, 59]] }];

	var WordClock = (function (_React$Component) {
	  _inherits(WordClock, _React$Component);

	  function WordClock(props) {
	    _classCallCheck(this, WordClock);

	    _get(Object.getPrototypeOf(WordClock.prototype), 'constructor', this).call(this, props);
	    this.state = { date: new Date() };
	  }

	  _createClass(WordClock, [{
	    ...
	    value: function render() {
	      ...
	      var numbers = [1, 2, 3, 4, 5, 6, 7, 8, 10, 11, 12].map(function (i) {
	        return _react2['default'].createElement(_Number2['default'], { value: i, now: now });
	      });

	      var words = data.map(function (w) {
	        return _react2['default'].createElement(_Word2['default'], { text: w.text, ranges: w.ranges, now: now });
	      });
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          words,
	          numbers,
	          _react2['default'].createElement(_Word2['default'], { text: 'o\'clock', ranges: '[[0, 4]]', now: now })
	        ),
	        _react2['default'].createElement(
	          'section',
	          { className: 'minutes' },
	          _react2['default'].createElement(_Minute2['default'], { n: '1', now: now }),
	          _react2['default'].createElement(_Minute2['default'], { n: '2', now: now }),
	          _react2['default'].createElement(_Minute2['default'], { n: '3', now: now }),
	          _react2['default'].createElement(_Minute2['default'], { n: '4', now: now })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Word = (function (_React$Component) {
	  ...
	  _createClass(Word, [{
	    key: 'between',
	    value: function between(a, b, c) {
	      return a >= b && a <= c;
	    }
	  }, {
	    key: 'contains',
	    value: function contains(minute, arr) {
	      for (var i = 0; i < arr.length; i++) {
	        if (this.between(minute, arr[i][0], arr[i][1])) return true;
	      }
	      return false;
	    }
	  }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Minute = (function (_React$Component) {
	  _inherits(Minute, _React$Component);

	  function Minute() {
	    _classCallCheck(this, Minute);

	    _get(Object.getPrototypeOf(Minute.prototype), 'constructor', this).apply(this, arguments);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ClockBitListPair = __webpack_require__(58);
	  ...
	  _createClass(Clock, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        'div',
	        null,
	        _react2['default'].createElement(_Header2['default'], { date: date }),
	        _react2['default'].createElement(
	          'div',
	          { className: 'clock' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ClockBitList = __webpack_require__(59);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ClockBit = __webpack_require__(60);
	  ...
	  _createClass(ClockBitList, [{
	    ...
	    value: function render() {
	      ...
	      var bitNodes = bits.map(function (bit) {
	        return _react2['default'].createElement(_ClockBit2['default'], { bitmask: bit, key: bit, value: value });
	      });
